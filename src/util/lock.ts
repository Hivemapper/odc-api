...
export const DEFAULT_TIME = 1707170100000; // 2024-01-10, dashcam default time is less than this date. So once the date is bigger, we know that system time is set
let lockTime = 0;
