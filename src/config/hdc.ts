...
export const QUARANTINE_METADATA_FOLDER = '/mnt/data/quarantine';
export const CSV_CACHE_FOLDER = '/mnt/data/csv';
...
export const ML_MODEL_PATH = '/opt/dashcam/bin/n800_1x2_float16.tflite';
